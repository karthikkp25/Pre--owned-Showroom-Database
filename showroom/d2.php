...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["Customer_ID"]) && !empty($_POST["Customer_ID"])) {
        ...
        // SQL to delete the record based on Customer_ID
        $deleteSQL = "DELETE FROM Customer WHERE Customer_ID = $customerID";

        // Execute the query
        if ($conn->query($deleteSQL) === TRUE) {
            echo "Record with Customer_ID $customerID has been deleted successfully.";
        } else {
            echo "Error deleting record: " . $conn->error;
        }
    } else {
        echo "Customer_ID is required.";
    }
}
...
<body>
    <header>
        ...
        <div class="top-right">
            <a href="customer_details.php" class="btn">Customer Page</a>
        </div>
    </header>
